...
public class HttpServerUtil implements HttpServerRequestCallback {


    private static HttpServerUtil mInstance;
    ...
    public void onRequest(AsyncHttpServerRequest request, AsyncHttpServerResponse response) {
        ELog.d("====00000000====" + request.getPath());
        ELog.d("====11111111====" + request.getMethod());
        ELog.d("====22222222====" + request.getBody());
        ELog.d("====33333333====" + request.getHeaders());
        ELog.d("====44444444====" + request.getQuery());
        ELog.d("====55555555====" + request.getMatcher());
        ELog.d("====66666666====" + request.getSocket());
        //这个是获取header参数的地方，一定要谨记哦
        Multimap headers = request.getHeaders().getMultiMap();
        ELog.d("===1111=====2222222222============" + headers);
        response.send("进来了，哈哈");
        ELog.d("===1111=====3333333333============");


        if (request.getMethod().equals("POST")) {
            Multimap parms = ((AsyncHttpRequestBody<Multimap>) request.getBody()).get();
            ELog.d("========POST==========" + request.getBody().get());
            ELog.d("========POST==========" + parms.toString());
